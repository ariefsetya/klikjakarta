...
//==============================================================================================================
        ...
        $.ajax({
            ...
            success: function(data_return){
                ...
                data +='<tr>';
                    ...
                    data +='<th style="width:100px" class="text-left">Priority</th>';
                    data +='<th class="text-left">Title</th>';
                    data +='<th style="width:100px" class="text-left">Due Date</th>';
                    data +='<th style="width:100px" class="text-left">Check By</th>';
                    data +='<th style="width:120px" class="text-left">Progress</th>';
                        ...
                        '<tr>'+
                            '<td colspan="2">'+
                                '<select required type="text" id="jenis" data-transform="input-control">'+
                                    '<option value="files">List</option>'+
                                '</select>'+
                            '</td>'+
                        '</tr>'+
                        '<tr>'+
    ...
    function complete(idtodo){
        ...
        refreshview();
            ...
            $.ajax({
            type: "POST",
            url: 'dolist/complete_task',
            data : {"id": idtodo },
            dataType:'json',
            success: function(data_return){
                var hasil = data_return;
                    menuartikel(hasil['idartikel'],"list",activecaption);
                }
            });
    }
